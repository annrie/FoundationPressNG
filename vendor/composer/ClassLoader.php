...
class ClassLoader {
    ...
    public function getPrefixes() {         if ( ! empty($this->prefixesPsr0) ) {
    ...
    public function getFallbackDirs() {         return $this->fallbackDirsPsr0;
    }

    public function getFallbackDirsPsr4() {         return $this->fallbackDirsPsr4;
    }
