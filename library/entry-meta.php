...
if ( ! function_exists( 'foundationpress_entry_meta' ) ) :
	function foundationpress_entry_meta() {
		...
		echo '<time class="updated mytime" datetime="' . get_the_time( 'c' ) . '">' . sprintf( __( '<i class="fas fa-calendar" aria-hidden="true"></i> %1$s at %2$s.', 'foundationpress' ), get_the_date(), get_the_time() ) . '</time>';
