...
<header class="front-hero" role="banner">
	<div class="marketing">
		<div class="tagline">
			...
			<a role="button" class="download large button sites-button hide-for-small-only" href="https://github.com/annrie/FoundationPressNG">Download FoundationPressNG</a>
		</div>

		<div class="watch">
    <!-- <span id="stargazers"><a href="https://github.com/annrie/FoundationPressNG">1.5k stargazers</a></span> -->
			<span id="twitter"><a href="https://twitter.com/muraie_jin">@muraie_jin</a></span>
		</div>
	</div>
